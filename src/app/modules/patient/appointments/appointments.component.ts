      ...
      .pipe(
        ...
        switchMap(() => {
          ...
          if (this.selected === 'archived') {
            return this.appointmentService.getArchivedAppointmentsByPatient(this.authService.currentUserValue.id);
          } else {
            return this.appointmentService.getActiveAppointmentsByPatient(this.authService.currentUserValue.id);
          }
        }),
        map(data => {
